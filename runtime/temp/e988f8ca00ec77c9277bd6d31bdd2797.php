<?php /*a:1:{s:73:"D:\phpstudy_pro\WWW\seho\Hotel\application\admin\view\house\maintain.html";i:1577335493;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <table class="layui-table" lay-even lay-skin="nob">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?php echo url('admin/house/house_edit',['id'=>$vo['id']]); ?>" class="layui-btn">置空</a>
                    <a href="<?php echo url('admin/house/repair',['id'=>$vo['id']]); ?>" class="layui-btn">维修</a>
                    <a href="<?php echo url('admin/house/clean',['id'=>$vo['id']]); ?>" class="layui-btn">待打扫</a>
                </td>
            </tr>
